        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex mb-4">
              ...
              <h2 className="text-lg md:text-xl font-bold text-[#0284c7]">Vivi Shop</h2>
            </div>
            <p className="text-[#696969] text-xs md:text-sm leading-relaxed">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-[#0284c7]">ჩვენს შესახებ</h3>
          ...
          <div className="text-center md:text-left">
            <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-[#0284c7] ">წესები და პირობები</h3>
            <ul className="space-y-2">
              <li className="leading-[12px]">
          ...
          {/* Contact Us */}
          <div className="text-center md:text-left">
            <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-[#0284c7]">დაგვიკავშირდით</h3>
            <ul className="space-y-2">
              <li className="flex items-start justify-center md:justify-start leading-[1px]">
                ...
                <span className="text-gray-300 text-xs md:text-sm text-[#696969] hover:text-[#0284c7] transition-colors">პეკინის 24, თბილისი, საქართველო</span>
              </li>
              <li className="flex items-center justify-center md:justify-start leading-[1px]">
