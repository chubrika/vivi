  ...
  return (
    <footer className="bg-[rgb(2_132_199/0.06)] border-t-[1px] border-[#0284c73b]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="grid grid-cols-2 gap-4 md:contents">
            ...
            <div className="text-left">
              ...
              <ul className="space-y-2">
                <li className="flex items-center text-[12px] text-[#696969] hover:text-[#0284c7] justify-start leading-[1px]">
                  ...
                  <span className="transition-colors">პეკინის 24, თბილისი</span>
                </li>
                <li className="flex items-center text-[12px] text-[#696969] hover:text-[#0284c7] justify-start leading-[1px]">
                  ...
                  <a href="tel:+995123456789" className=" transition-colors">
                    +995 123 456 789
                  </a>
                </li>
                <li className="flex items-center text-[12px] text-[#696969] hover:text-[#0284c7] justify-start leading-[1px]">
                  ...
                  <a href="mailto:info@vivishop.com" className=" transition-colors">
                    vivishopinfo2@gmail.com
                  </a>
                </li>
                
                {/* Social Media Icons */}
                <li className="pt-2 leading-[1px]">
      ...
      <div className="border-t border-white pt-6 md:pt-6 mb-6 md:mb-6 pt-6 md:pt-6 text-center text-gray-300 text-xs md:text-sm">
          <p className="text-[#696969] font-semibold">&copy; {new Date().getFullYear()} vivi.ge. ყველა უფლება დაცულია.</p>
        </div>
    </footer>
  );
};
